...
# Paths
# ---------------------------------------------------------------------------
# This file lives at <repo>/automation/lc_sync/config.py. `problems/` and
# `README.md` are user-facing content and stay at the true repo root;
# everything else (state, dependencies, tests) lives under automation/ to
# keep the repo root itself uncluttered.
...
ACTIVITY_SVG_README_RELPATH = "automation/assets/activity.svg"
